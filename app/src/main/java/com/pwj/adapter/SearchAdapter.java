...
public class SearchAdapter extends SortedListAdapter<WordModel> {
    ...
    public SearchAdapter(Context context, Comparator<WordModel> comparator, Listener listener) {
    ...
    protected ViewHolder<? extends WordModel> onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent, int viewType) {
        final ItemSearchBinding binding = ItemSearchBinding.inflate(inflater, parent, false);
