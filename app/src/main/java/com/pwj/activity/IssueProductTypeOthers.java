...
public class IssueProductTypeOthers extends BaseActivityIssue {
...
//            } else {
            LoginInfo.setString(IssueProductTypeOthers.this, "pwj_brand", et2_str);
            if (!TextUtils.isEmpty(et1_str)) {
                content = "名称：" + et1_str + "。\n";
            }
            if (!TextUtils.isEmpty(et2_str)) {
                content = content + "品牌：" + et2_str + "。\n";
            }
            if (!TextUtils.isEmpty(et3_str)) {
                content = content + "型号：" + et3_str + "。\n";
            }
            if (!TextUtils.isEmpty(et4_str)) {
                content = content + "规格：" + et4_str + "。\n";
            }
            if (!TextUtils.isEmpty(et5_str)) {
                content = content + "单价：" + et5_str + "。\n";
            }
