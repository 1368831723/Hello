...
public class PushPersonIssueActivity extends BaseActivityComment implements View.OnClickListener, TextWatcher {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_person_push_issue);
...
//        phone = getIntent().getStringExtra("phone");
    ...
    private void initAdapter() {
        ...
        EasyHttp.post(IpConfig.URL_SQL)
                .params("query", "SELECT * FROM comment_1_issue WHERE phone = '" + phone + "' ORDER BY id DESC limit 0,1")
                .timeStamp(true)
                .execute(new SuccessCallBack<String>() {
                    @Override
                    public void onSuccess(String json) {
                        data_comment = GsonUtils.getGsonToList(json, Comment.class);
                        Log.e("结果 ", "onSuccess: "+data_comment.size() );
                        String sql ="SELECT login.url3,login.user_name,"+data_comment.get(0).getTable_name()+".* FROM login,"+data_comment.get(0).getTable_name()+" WHERE "+data_comment.get(0).getTable_name()+".phone=login.phone AND "+data_comment.get(0).getTable_name()+".id = " + data_comment.get(0).getTable_id() + " ORDER BY id DESC limit 0,1";
                        Log.e("结果 ", "onSuccess: "+sql );
                        EasyHttp.post(IpConfig.URL_SQL)
                                .params("query", "SELECT login.url3,login.user_name,"+data_comment.get(0).getTable_name()+".* FROM login,"+data_comment.get(0).getTable_name()+" WHERE "+data_comment.get(0).getTable_name()+".phone=login.phone AND "+data_comment.get(0).getTable_name()+".id = " + data_comment.get(0).getTable_id() + " ORDER BY id DESC limit 0,1")
                                .timeStamp(true)
                                .execute(new SuccessCallBack<String>() {
                                    @Override
                                    public void onSuccess(String json) {
                                                            ...
                                                            .execute(new SuccessCallBack<String>() {
                                                                ...
                                                                public void onSuccess(String s) {
                                                                    ...
                                                                    if (key == data.size()) {
                                                                        ...
                                                                        recycle.setLayoutManager(new LinearLayoutManager(PushPersonIssueActivity.this));
        ...
        switch (view.getId()) {
            ...
            case R.id.img_search:
                ...
                if (keyWords.length() > 0) {
                    ...
                    Util.showToast(PushPersonIssueActivity.this, "请输入关键词");
                }
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tv_content:
                ...
                clickImgComment(PushPersonIssueActivity.this, view, title, id, table_name, user_img, user_name, other_phone);
                break;
            case R.id.img_comment:
                ...
                clickImgComment(PushPersonIssueActivity.this, view, title0, id0, table_name0, user_img, user_name, other_phone0);
                break;
            case R.id.img_like:
                if (checkPhone(PushPersonIssueActivity.this)) {
                    ...
                    clickImgLike(PushPersonIssueActivity.this, view, position, id1, table_name1, flag_like);
                }
                break;
            case R.id.share:
                ...
                if ("".equals(url2)) {
                    clickShareNoPicture("",contact, other_phone2, title2);
                } else {
                    if (url_type == 1) {
                        clickShare("",contact, other_phone2, title2, position, url2);
                    } else {
                        clickShareNoPicture("",contact, other_phone2, title2);
                    }
                }
                ...
                try {
                    ...
                    if (file.exists()) {
                        if (!DoubleUtils.isFastDoubleClick()) {
                            Intent intent1 = new Intent(PushPersonIssueActivity.this, PictureVideoPlayActivity.class);
        ...
        EasyHttp.downLoad(data.get(position).getUrl())
                ...
                .execute(new DownloadProgressCallBack<String>() {
                    ...
                    public void onError(ApiException e) {
                        Util.showToast(PushPersonIssueActivity.this, "播放出错");
                    }
                    ...
                    public void update(long bytesRead, long contentLength, boolean done) {
                        ...
                        if (done) {//下载完成
                            ...
                            if (!DoubleUtils.isFastDoubleClick()) {
                                Intent intent = new Intent(PushPersonIssueActivity.this, PictureVideoPlayActivity.class);
    ...
    private void selectMap(int position) {
        ...
        checkMap();
        dialogChooseMap = new DialogChooseMap(PushPersonIssueActivity.this, baiDu, gaoDe, R.style.dialog_choose, new DialogChooseMap.ICustomDialogEventListener() {
            @Override
...
//                                intent2 = Intent.getIntent("androidamap://route?sourceApplication=softname" + "&sname=" + "请选择起点" + "&dname=" + end_location + "&dev=0&m=0&t=1");
    ...
    private void full_choose_map() {
        WindowManager windowManager = PushPersonIssueActivity.this.getWindowManager();
    ...
    private class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            if (viewType == ITEM_RECRUIT) {
                View view = LayoutInflater.from(PushPersonIssueActivity.this).inflate(R.layout.item_recruit_issue, parent, false);
                Recruit_ViewHolder recruit_viewHolder = new Recruit_ViewHolder(view);
                return recruit_viewHolder;
            } else if (viewType == ITEM_PRODUCT) {
                View view = LayoutInflater.from(PushPersonIssueActivity.this).inflate(R.layout.item_person_concern, parent, false);
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof Recruit_ViewHolder) {
                Glide.with(PushPersonIssueActivity.this).load(user_img).into(((Recruit_ViewHolder) holder).img);
                ...
                ((Recruit_ViewHolder) holder).share_recruit.setOnClickListener(PushPersonIssueActivity.this);
                ((Recruit_ViewHolder) holder).share_recruit.setTag(position_all, position);
                ((Recruit_ViewHolder) holder).go.setOnClickListener(PushPersonIssueActivity.this);
                ...
                if ("".equals(data.get(position).getUrl())) {
                    ...
                    if (data.get(position).getUrl_type() == 1) {
                        ...
                        ((Product_ViewHolder) holder).gridView.setAdapter(new AssNineGridViewClickAdapter(PushPersonIssueActivity.this, imageInfos));
                    } else {
                        ...
                        RequestOptions requestOptions = new RequestOptions()
                                ...
                                .dontAnimate();
                        Glide.with(PushPersonIssueActivity.this).load(data.get(position).getUrl()).apply(requestOptions).into(((Product_ViewHolder) holder).iv);
                        ((Product_ViewHolder) holder).btn_play.setOnClickListener(PushPersonIssueActivity.this);
                ...
                Glide.with(PushPersonIssueActivity.this).load(user_img).into(((Product_ViewHolder) holder).img);
                ...
                ((Product_ViewHolder) holder).share.setOnClickListener(PushPersonIssueActivity.this);
                ((Product_ViewHolder) holder).share.setTag(position_all, position);

                ((Product_ViewHolder) holder).tv_content.setOnClickListener(PushPersonIssueActivity.this);
                ...
                ((Product_ViewHolder) holder).img_comment.setOnClickListener(PushPersonIssueActivity.this);
                ...
                ((Product_ViewHolder) holder).img_like.setOnClickListener(PushPersonIssueActivity.this);
