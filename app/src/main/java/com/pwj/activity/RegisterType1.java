...
public class RegisterType1 extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initLayout(R.layout.activity_register_type1);
        ...
        timerTask = new TimerTask() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {      // UI thread
                    ...
                    public void run() {
                        recLen--;
                        user_code_btn.setVisibility(View.INVISIBLE);
...
//            switch (msg.what) {
//                case 1:
//                    Intent intent = new Intent(RegisterType1.this, RegisterAlready.class);
//                    startActivity(intent);
//                    finish();
//                    break;
//                case 2:
//                    Intent intent1 = new Intent(RegisterType1.this, RegisterSuccess.class);
...
//                                Log.e(TAG, "数据: " + name_str + "-" + pwd_str + "-" + phone_str + "-" + type);
...
//                                    connection = Jdbc.getConnection("root", "1q23lyc45j");
//                                    Update.update_type1(connection, name_str, pwd_str, phone_str, type, others_remarks, uuid);
//                                    Log.e(TAG, "name_str " + name_str + "pwd_str" + pwd_str + "phone_str" + phone_str + "type" + type + "uuid" + uuid);
//                                }
//                            }
//                        }).start();
                    }
                    break;
                case 2:             //获取验证码成功,注意查看
                    Util.showToast(RegisterType1.this, "获取验证码成功,注意查看");
                    break;
                case 3:
                    //获取验证码失败,请填写正确的手机号码
                    Util.showToast(RegisterType1.this, "获取验证码失败,请填写正确的手机号");
                    break;
                case 4:             //验证码验证错误
                    Util.showToast(RegisterType1.this, "验证码错误");
                    break;
            }
        }
    };
                ...
                .execute(new SuccessCallBack<String>() {
                    ...
                    public void onSuccess(String s) {
                        ...
                        if (s.length() > 12) {  //账号存在
                            ...
                            EasyHttp.post(IpConfig.URL_SQL)
                                    .params("query", "update login set `user_name`= '" + name_str + "',`pwd`='" + pwd_str + "' ,`phone`='" + phone_str + "',`type`='" + type + "',`remarks`='" + others_remarks + "' where `uid`='" + uuid + "'")
                                    .timeStamp(true)
                                    .execute(new SuccessCallBack<String>() {
                                        @Override
                                        public void onSuccess(String s) {
                                            Intent intent = new Intent(RegisterType1.this, RegisterSuccess.class);
            ...
            if (!TextUtils.isEmpty(pwd_str)) {                                //密码不为空
                if (pwd_str.equals(confirm_str)) {                            //密码一致
                    if (PhoneFormatCheckUtils.isChinaPhoneLegal(phone_str)) {//手机号正确
                        ...
                        Util.showToast(RegisterType1.this, "请输入正确的手机号");
                    }
                } else {
                    Util.showToast(RegisterType1.this, "两次输入的密码不一致");
                }
            } else {
                Util.showToast(RegisterType1.this, "密码不能为空");
            }
        } else {
            Util.showToast(RegisterType1.this, "用户名不能为空");
        }
    }
