...
public class ProductDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initLayout(R.layout.activity_product_detail);
        ...
        if (adapter != null) {
            ...
            adapter = new BaseRcyAdapter(data, R.layout.item_product_comment) {
                ...
                public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
                    ...
                    Glide.with(ProductDetailActivity.this).load(data.get(position).getUrl3()).into(img);
                    ...
                    img_like.setOnClickListener(ProductDetailActivity.this);
            ...
            recycle.setLayoutManager(new LinearLayoutManager(ProductDetailActivity.this));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_publish:
                if (checkPhone(ProductDetailActivity.this)) {
                    comment = et_comment.getText().toString().trim();
                    if (!TextUtils.isEmpty(comment)) {
                        Log.e(TAG, "onViewClicked: comment" + comment);
                        insertComment();
                    } else {
                        Util.showToast(ProductDetailActivity.this, "抱歉,评论不能为空");
                    }
                }
                break;
                        ...
                        EasyHttp.post(IpConfig.URL_SQL)
                                ...
                                .execute(new SuccessCallBack<String>() {
                                    ...
                                    public void onSuccess(String s) {
                                        ...
                                        Util.showToast(ProductDetailActivity.this, "发表成功");
                                        et_comment.setText("");
                                        Keyboard.getInstance().hideKeyBoard(et_comment);
                                        urlsss = LoginInfo.getString(ProductDetailActivity.this, "user_img", "");
                                        namesss = LoginInfo.getString(ProductDetailActivity.this, "user_name", "");
                                            ...
                                            EasyHttp.post(IpConfig.URL_SQL)
                                                    ...
                                                    .execute(new SuccessCallBack<String>() {
                                                        ...
                                                        public void onSuccess(String s) {
                                                            ...
                                                            LoginInfo.setString(ProductDetailActivity.this, "user_name", namesss);
                                                            LoginInfo.setString(ProductDetailActivity.this, "user_img", urlsss);
                                                        }
                                                    });
                                        } else {
                                            Comment comment1 = new Comment();
    ...
    private void insertConcern() {
        EasyHttp.post(IpConfig.URL_SQL)
                ...
                .execute(new SuccessCallBack<String>() {
                    @Override
                    public void onSuccess(String s) {
                        Util.showToast(ProductDetailActivity.this, "关注成功");
                        tv_concern.setVisibility(View.INVISIBLE);
                        tv_concern_ready.setVisibility(View.VISIBLE);
                    }
                });
    ...
    private void deleteConcern() {
        EasyHttp.post(IpConfig.URL_SQL)
                ...
                .execute(new SuccessCallBack<String>() {
                    @Override
                    public void onSuccess(String s) {
                        Util.showToast(ProductDetailActivity.this, "已取消关注");
    ...
    private void deleteCollect() {
        EasyHttp.post(IpConfig.URL_SQL)
                ...
                .execute(new SuccessCallBack<String>() {
                    @Override
                    public void onSuccess(String s) {
                        Util.showToast(ProductDetailActivity.this, "已取消收藏");
    ...
    private void plus_like(int position, ImageView img_like, TextView tv_like) {
        ...
        FloatingText floatingText = new FloatingText.FloatingTextBuilder(ProductDetailActivity.this)
