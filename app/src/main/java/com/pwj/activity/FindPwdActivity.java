...
public class FindPwdActivity extends BaseActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initLayout(R.layout.activity_find_pwd);
        ButterKnife.bind(this);
        title_tv.setText("密码找回");
    }
    ...
    @OnClick({R.id.title_im,R.id.user_code_btn, R.id.find})
...
//                    Toast.makeText(RegisterActivity.this, "验证码正确", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(FindPwdActivity.this, FindPwdResult.class);
                    intent.putExtra("phone_str",phone_str);
                    startActivity(intent);
                    finish();
                    break;
                case 2:             //获取验证码成功,注意查看
                    Util.showToast(FindPwdActivity.this,"获取验证码成功,注意查看");
                    break;
                case 3:
                    Util.showToast(FindPwdActivity.this,"获取验证码失败,请填写正确的手机号");//获取验证码失败,请填写正确的手机号码
                    break;
                case 4:             //验证码验证错误
                    Util.showToast(FindPwdActivity.this,"验证码错误");
                    break;
            }
        }
    };
...
//                    } else
    ...
    private void judgeCode() {
        if (PhoneFormatCheckUtils.isChinaPhoneLegal(phone_str)) {//手机号正确
            ...
            Util.showToast(FindPwdActivity.this,"请输入正确的手机号");
        }
    }
