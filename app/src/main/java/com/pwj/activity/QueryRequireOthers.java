...
public class QueryRequireOthers extends BaseActivityQueryRequire {
    private MyAdapter myAdapter;

    @Override
    public void initData() {
        data = new ArrayList<>();
        title_tv.setText("其他需求");
        queryType();
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.issue:
                startActivity(IssueRequireOthers.class);
                finish();
                break;
        }
    }
    ...
    public void queryType() {
        EasyHttp.post(IpConfig.URL_SQL)
                .params("query","SELECT url,name,location,remarks,contact,phone FROM others order by id desc")
                .timeStamp(true)
                                    ...
                                    .execute(new SuccessCallBack<String>() {
                                        ...
                                        public void onSuccess(String s) {
                                            ...
                                            if (data_users.size()==data.size()){
                                                progressbar.setVisibility(View.GONE);
                                                recycler.setLayoutManager(new LinearLayoutManager(QueryRequireOthers.this, LinearLayoutManager.VERTICAL, false));
    ...
    private class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(QueryRequireOthers.this).inflate(R.layout.item_product, parent, false);
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            holder.gridView.setAdapter(new AssNineGridViewClickAdapter(QueryRequireOthers.this, imageInfos));
            ...
            Glide.with(QueryRequireOthers.this).load(url).into(holder.img);
            holder.name_tv.setText(user_name);
            holder.img.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(QueryRequireOthers.this, ChatActivity.class);
